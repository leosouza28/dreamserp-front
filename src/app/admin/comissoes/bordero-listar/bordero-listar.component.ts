...
@Component({
  selector: 'app-bordero-listar',
  templateUrl: './bordero-listar.component.html',
  styleUrls: ['./bordero-listar.component.scss']
})
export class BorderoListarComponent {
  ...
  async busca(q: any) {
    ...
    try {
      ...
      let data: any = await this.endpointsService.getBorderos({ ...values });
      this.data = data;
    } catch (error) {
